...
function Uc(e, n, t, r, l, o, u, i, s) {
  (Et = !1), (Rr = null), jc.apply(Fc, arguments);
}
...
function ua(e) {
  ...
  function S(f, a, d, v) {
    ...
    if (L.done) return t(f, x), F && gn(f, P), E;
    if (x === null) {
...
function Ti(e, n, t, r, l) {
  ...
  if ((Gn(n, l), n.stateNode === null))
    Pr(e, n), oa(n, t, r), _o(n, t, r, l), (r = !0);
  else if (e === null) {
    var u = n.stateNode,
      i = n.memoizedProps;
    u.props = i;
...
function Li(e, n, t, r, l) {
  return bn(), iu(l), (n.flags |= 256), le(e, n, t, r), n.child;
}
...
function ad(e, n, t) {
  ...
  switch ((uu(n), n.tag)) {
    ...
    case 4:
      return (
        nt(), Lo(e, n), e === null && $t(n.stateNode.containerInfo), ne(n), null
      );
    case 10:
...
function dd(e, n) {
  ...
  for (ho = { focusedElem: e, selectionRange: t }, Ir = !1, k = n; k !== null; )
...
function $a(e) {
  ...
  n !== null && ((e.alternate = null), $a(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[je], delete n[Vt], delete n[go], delete n[Xf], delete n[Gf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
  ...
  switch (e.tag) {
    ...
    case 22:
      if (
        ...
        e.mode & 1 ? ((te = (c = te) || m), Ne(n, e), (te = c)) : Ne(n, e),
        De(e),
        r & 8192)
      ) {
        if (
...
function Oe(e, n, t, r) {
  ...
  Gt(e, t, r),
    (!(R & 2) || e !== Z) &&
      ...
      pe(e, r),
      t === 1 && R === 0 && !(n.mode & 1) && ((rt = H() + 500), ul && hn()));
}
function pe(e, n) {
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Jo(n, t | 1), pe(n, H()), !(R & 6) && ((rt = H() + 500), hn()));
      }
      break;
    case 13:
      Tn(function () {
...
ys = xu;
gs = Tn;
var zd = { usingClientEntryPoint: !1, Events: [Jt, Un, ol, hs, vs, xu] },
  vt = {
...
const Rd = (e) => {
    const n = async (l) => {
        let o = await t(e.cityInput).then((m) => m),
          u = await o[1][1],
          i = await o[2][1];
        console.log(u), console.log(i);
        let s = `https://api.open-meteo.com/v1/forecast?latitude=${u}&longitude=${i}&current=weathercode`,
          c = await fetch(s)
            .then((m) => m.json())
            .then((m) => m.current.weathercode);
        e.handleSearch(c);
      },
      t = async (l) => {
        const o = "Rn83GNo+8YEZHpF0LDiXDA==ZnabpQj1Aw5ZZyny";
        try {
          const u = await fetch(
            `https://api.api-ninjas.com/v1/geocoding?city=${l}`,
            {
              method: "GET",
          ...
          return console.log(i), Object.entries(i[0]);
        } catch (u) {
          return console.error("Error:", u), null;
        }
      },
      r = (l) => {
        e.handleInputChange(l);
      };
    return oe.jsxs("div", {
      children: [
        "WeatherSearch",
        ...
        oe.jsx("br", {}),
        oe.jsx("br", {}),
        oe.jsx("button", { onClick: n, children: "Buscar pronóstico" }),
      ],
    });
  },
  Od = (e) => oe.jsx("div", { children: e.shownWeather && e.shownWeather });
function Md() {
  const [e, n] = Lt.useState(""),
    [t, r] = Lt.useState(""),
    l = (u) => {
      r(u.target.value);
    },
  ...
  return oe.jsxs(oe.Fragment, {
    children: [
      oe.jsx(Rd, { cityInput: t, handleSearch: o, handleInputChange: l }),
      oe.jsx(Od, { shownWeather: e }),
    ],
  });
}
Ql.createRoot(document.getElementById("root")).render(
  oe.jsx(wc.StrictMode, { children: oe.jsx(Md, {}) })
);
